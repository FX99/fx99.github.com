    ...
    if (browser.versions.mobile) {
        if (isWeiXin() || isQQ() || isWeiBo()) {
            ...
            switch(parameters.shareType) {
                case "10001":
                    //_url = "json/data.json";
                    _url="portal.gd.sumaott.com:8080/PortalServer-App/new/ptl_ipvp_vod_vod013?hmac=2f2253f288&nonce=1240044448&numberOfResults=12&plocation=001&pserialNumber=c615ac6662956b4274be223430b00029&pserverAddress=portal.gd.sumaott.com&ptoken=c615ac6662956b4274be223430b00029&ptype=4&puser=freeuser&pversion=030101&recommendTypeID=1&resolution=&start=0&timestamp=1478048946&type=0&programID="+parameters.programID;
                    scheme = scheme
